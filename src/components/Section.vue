<template>
    <main
        ...
        <div class="w-[550px] h-[47.5rem]  ">
            <!-- Header -->
            <div class="flex justify-between items-center border-b px-4 py-3 sticky top-0 bg-white dark:bg-dim-900">
                <!-- Title -->
                <h2 class="text-gray-800 dark:text-black font-bold font-sm">Home</h2>
                <!-- /Title -->

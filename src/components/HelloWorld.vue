<template>
    <div class="container  fixed h-full w-[34rem] top-0 left-0 bg-white border-r border-gray-200 shadow-lg z-50">
        <section class="flex flex-col items-center ml-[190px]">
            <a class="flex my-2 justify-center xl:justify-start" href="#">
                <svg viewBox="0 0 24 24" class="w-8 h-8 text-blue-400 " fill="currentColor">
                    <g>
                        <path
            ...
            <nav class="mt-5">
                ...
                <a href="#"
                    class="flex items-center justify-center xl:justify-start text-black  hover:text-blue-400 dark:hover:text-blue-400 mb-8 transition duration-350 ease-in-out">
                    <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

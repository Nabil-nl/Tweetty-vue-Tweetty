<template>
    <div class="container fixed h-full w-[31rem] top-0 left-0 bg-white border-r border-[#bdbdbd] shadow-lg z-50">
        <section class="flex flex-col items-center ml-[190px]">
            ...
            <nav class="mt-5">
                <a href="#"
                    class="flex items-center justify-center xl:justify-start text-[#1DA1F2] mb-8 transition duration-350 ease-in-out">
                ...
                <a href="#"
                    class="flex items-center justify-center xl:justify-start text-black  hover:text-[#1DA1F2] dark:hover:text-[#1DA1F2] mb-8 transition duration-350 ease-in-out">
                    <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
